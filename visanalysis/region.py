...
class MultiROISelector(QWidget):
    ...
    def initUI(self):
        ...
        # Delete ROIs button
        self.deleteROIsButton = QPushButton("Delete ROI set", self)
        self.deleteROIsButton.clicked.connect(self.onPressedDeleteRoisButton)
        self.grid.addWidget(self.deleteROIsButton, 11, 2)
    ...
    def onPressedDeleteRoisButton(self):
        self.ImagingData.deleteRois(str(self.RoiComboBox.currentText()))
